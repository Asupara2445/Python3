...
def get_args():
    ...
    parser.add_argument('--pre_gen_max_epoch', type=int, default=20)
    parser.add_argument('--pre_dis_max_epoch', type=int, default=5)
    ...
    parser.add_argument('--seq_len_en', type=int, default=16)
    parser.add_argument('--seq_len_jp', type=int, default=20)
